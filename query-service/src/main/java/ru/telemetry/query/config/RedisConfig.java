...
public class RedisConfig {
    ...
    public ReactiveRedisTemplate<String, TelemetryState> telemetryStateRedisTemplate(
        ...
        // Тот же ObjectMapper, что и на стороне telemetry-processor, который эти значения пишет —
        // без disable(WRITE_DATES_AS_TIMESTAMPS) Instant читался бы как число, а не ISO-8601 строка.
